...
export const USER_PROFILES = {
  bujang: {
    ...
    pomodoro: { focusTime: 20, restTime: 5, label: "Adaptive Mode", suggestion: "AI Suggestion: Your optimal duration is 20 mins (Fast Pace)." },
    
    // Insight Versi Simpel (Clean)
    insights: [
  ...
  sarah: {
    ...
    pomodoro: { focusTime: 45, restTime: 10, label: "Deep Focus", suggestion: "AI Suggestion: 45 mins focus suits your stamina." },
    insights: [
  ...
  budi: {
    ...
    pomodoro: { focusTime: 15, restTime: 15, label: "Burnout Prevention", suggestion: "AI Suggestion: High fatigue detected." },
    insights: [
      { title: "Need Rest", desc: "Your study pattern is fragmented, take a break.", icon: Award, color: "purple" },
